 ...
 */
public class VistaLayout extends LinearLayout{
    ...
    public VistaLayout(Context context) {
        this(context, null);
    }

    public VistaLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public VistaLayout(Context context, AttributeSet attrs, int defStyleAttr) {
