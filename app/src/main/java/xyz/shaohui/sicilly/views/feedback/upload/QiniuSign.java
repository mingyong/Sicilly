...
public class QiniuSign {
    ...
    private QiniuSign(String accessKey, SecretKeySpec secretKeySpec) {
        this.accessKey = accessKey;
        this.secretKey = secretKeySpec;
    }

    public static QiniuSign create(String accessKey, String secretKey) {
        if (StringUtils.isNullOrEmpty(accessKey) || StringUtils.isNullOrEmpty(secretKey)) {
            throw new IllegalArgumentException("empty key");
        }
        byte[] sk = StringUtils.utf8Bytes(secretKey);
        SecretKeySpec secretKeySpec = new SecretKeySpec(sk, "HmacSHA1");
        return new QiniuSign(accessKey, secretKeySpec);
    }
    ...
    public String uploadTokenWithDeadline(String bucket, String key, long deadline, StringMap policy, boolean strict) {
        ...
        QiniuMap map = new QiniuMap(scope, deadline);
    ...
    class QiniuMap {
        ...
        QiniuMap(String scope, long deadline) {
            this.scope = scope;
